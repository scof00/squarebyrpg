  ...
  return (
    <div className="opponentContainer">
      {enemies.map((enemy, i) => {
        ...
        const isControllerHighlighted = i === controllerHighlight;

        return (
          <div
            key={enemy.id}
            className={`enemyCard ${isSelected ? "selected" : ""} ${isAttacking ? "enemyAttack" : ""} ${isControllerHighlighted ? "controller-highlight" : ""}`}
